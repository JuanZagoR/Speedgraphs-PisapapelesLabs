...
sleep 2
sudo apt install sudo docker.io docker-compose net-tools wget curl -y && echo -e "\e[0;32mDependencias instaladas correctamente\e[0m" || echo -e "\e[0;31mHubo un problema al instalar dependencias\e[0m"
...
cd /mnt/Docker/Speedgraphs && echo echo -e "\e[0;32mDirectorios creados\e[0m" || echo -e "\e[0;31mError al acceder al directorio\e[0m"
