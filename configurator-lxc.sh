...
sleep 2
echo -e "\e[1;36m➤ Los siguientes paquetes serán actualizados:\e[0m"
...
echo -e "\e[1;36m➤ Instalando dependencias faltantes...\e[0m"
...
sleep 2
wget https://raw.githubusercontent.com/JuanZagoR/Speedgraphs-PisapapelesLabs/dev/Docker-Compose%20Templates/HomeAssistant/docker-compose.yaml -O docker-compose.yaml && echo -e "\e[0;32m✔ Plantilla descargada correctamente\e[0m" || echo -e "\e[0;31m✖ Hubo un problema al descargar la plantilla\e[0m"
